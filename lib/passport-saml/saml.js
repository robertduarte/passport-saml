...
SAML.prototype.getAuthorizeForm = function (req, callback) {
  var self = this;
  this._saml._functionLogger.log("Req Query Login AppVersion: ", req && req.query ? req.query : "NotFound");
  this._saml._functionLogger.log("Req Body Login AppVersion: ", req && req.body ? req.body : "NotFound");
  ...
  self.generateAuthorizeRequest(req, { isPassive: self.options.passive, isHttpPostBinding: true }, function(err, request) {
    ...
    this._saml._functionLogger.log("SAMLRequest:",request);
...
SAML.prototype.validatePostRequest = function (container, callback) {
  ...
  this._saml._functionLogger.log("SAML Strategy - SAMLRequest:",xml);
