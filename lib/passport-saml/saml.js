...
SAML.prototype.getAuthorizeForm = function (req, callback) {
  var self = this;
  self._functionLogger.info("Req Query Login AppVersion: ", req && req.query ? req.query : "NotFound");
  self._functionLogger.info("Req Body Login AppVersion: ", req && req.body ? req.body : "NotFound");
